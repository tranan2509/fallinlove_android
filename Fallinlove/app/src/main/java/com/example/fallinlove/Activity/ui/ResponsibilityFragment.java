...
public class ResponsibilityFragment extends Fragment {
    ...
    public void getModel(View mView){
        ...
        responsibilities = ResponsibilityDB.getInstance(mView.getContext()).getsSorted(user, 2);
    }
    ...
    public static void move(Responsibility responsibility, Responsibility newResponsibility){
        ...
        List<Responsibility> responsibilitiesNew = ResponsibilityDB.getInstance(mView.getContext()).getsSorted(user, Responsibility.TYPE_RESPONSIBILITY);
    ...
    public static void add(Responsibility responsibility){
        ...
        List<Responsibility> newResponsibilities = ResponsibilityDB.getInstance(context).getsSorted(user, Responsibility.TYPE_RESPONSIBILITY);
