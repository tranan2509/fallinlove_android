...
public class ViewImageActivity extends AppCompatActivity implements View.OnClickListener, View.OnTouchListener {
    ...
    public void setView(){
        imgViewImage.setImageBitmap(ImageConvert.ArrayByteToBitmap(intent.getByteArrayExtra("image")));
    }

    public void setOnClick(){
        btnBack.setOnClickListener(this);
        btnDownload.setOnClickListener(this);
//        imgViewImage.setOnTouchListener(this);
    }
    ...
    private void saveImageToGallery(){
        ...
        imgViewImage.setDrawingCacheEnabled(true);
        Bitmap b = imgViewImage.getDrawingCache();
        MediaStore.Images.Media.insertImage(getContentResolver(), b, name, "Được lưu từ ứng dụng In Love");
        Toast.makeText(getApplicationContext(), "Lưu ảnh thành công", Toast.LENGTH_LONG).show();
    }
